...
func loadDataFromTable(conn *sqlx.DB) {
	conn.MustExec(`INSERT INTO tutorial.hits_all SELECT * FROM tutorial.hits_v1`)
}
...
DROP TABLE tutorial.hits_local
`

var dropAllTableSchema = `
DROP TABLE tutorial.hits_all
`
...
CREATE TABLE IF NOT EXISTS tutorial.hits_local
(
    WatchID UInt64,
    JavaEnable UInt8,
    Title String,
...
CREATE TABLE IF NOT EXISTS tutorial.hits_all AS tutorial.hits_local
ENGINE = Distributed(tm_cluster_two_shards, tutorial, hits_local, rand())
`
